...
export default function BookCoverPanel({
  bookdetails,
  onClose,
  onUpdateBook,
  mode,
  ...
  useEffect(() => {
    ...
    if (bookdetails?.cover_img_name) {
      ...
      setCoverImage(
        `${import.meta.env.VITE_BOOK_IMAGE_URL}${
          bookdetails.cover_img_name
        }`
      );
  ...
  const generateCover = async () => {
    ...
    try {
      ...
      message.success(
        hasGenerated ? "Cover regenerated" : "Cover generated"
      );
    } catch {
  ...
  const downloadCover = async () => {
    ...
    try {
      ...
      link.href = url;
      link.download = `${form.title || "book-cover"}.png`;
      ...
      message.success("Cover downloaded");
    } catch (error) {
      message.error("Failed to download cover");
    }
  };
    ...
    <div className="bcp-root">
      ...
      <div className="bcp-form">
        ...
        <div className="bcp-form__actions">
          ...
          <button
            className="bcp-btn bcp-btn--ghost"
            onClick={onClose}
          >
            Close
          </button>
        ...
        <div className="bcp-preview__inner">
          ...
          {loading && (
            <div className="bcp-preview__loading">
              ...
              <p className="bcp-preview__loading-text">
                Crafting your cover…
              </p>
            </div>
          )}
            ...
            <div className="bcp-card">
              ...
              <div className="bcp-card__frame">
                <img
                  src={coverImage}
                  alt="Book Cover"
                  className="bcp-card__img"
                />

                <div className="bcp-card__overlay">
                  {/* SAVE */}
                  <button
                    className="bcp-overlay-btn bcp-overlay-btn--save"
                    onClick={saveCover}
                    disabled={saving}
                  >
                    {saving ? (
                      <span className="bcp-spinner bcp-spinner--sm" />
                    ) : (
                      <svg
                        width="13"
                        height="13"
                  ...
                  {/* DELETE */}
                  <button
                    className="bcp-overlay-btn bcp-overlay-btn--danger"
          ...
          {!loading && !coverImage && (
            <div className="bcp-empty">
              ...
              <p className="bcp-empty__hint">
                Fill in the details and generate your cover
              </p>
            </div>
          )}
        </div>
      ...
      {deleteConfirm && (
        <div
          className="bcp-modal-backdrop"
          onClick={() =>
            !deleting && setDeleteConfirm(false)
          }
        >
          <div
            className="bcp-modal"
          ...
          >
            ...
            <h3 className="bcp-modal__title">
              Delete cover?
            </h3>

            <p className="bcp-modal__body">
              This will permanently remove the cover image.
              This action cannot be undone.
            </p>

            <div className="bcp-modal__actions">
              <button
                className="bcp-btn bcp-btn--ghost bcp-btn--sm"
              ...
              <button
                className="bcp-btn bcp-btn--danger bcp-btn--sm"
