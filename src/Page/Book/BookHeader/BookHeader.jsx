    ...
    <div className="bh-size-dropdown" onClick={e => e.stopPropagation()}>
      ...
      <div className="bh-size-dropdown__group">
        ...
        <div className="bh-size-dropdown__grid">
          {standard.map(k => (
            <SizeCard key={k} sizeKey={k} active={k === current}
              onSelect={() => { onSelect(k); onClose(); }} />
          ))}
        </div>
      </div>
      <div className="bh-size-dropdown__group">
    ...
    const id = setTimeout(() => {
      try {
        ...
        chapters.forEach((chapter, chIdx) => {
          ...
          paginateHTML(titleHTML, layout).forEach((html, pIdx) => {
          ...
          <div className="bh-print-modal__canvas">
            ...
            <div className="bh-print-modal__stack">
              {pages.map((pg, idx) => {
                ...
                if (pg.type === "cover") {
                  return (
                    <div key={idx} className="bh-print-modal__page-wrap"
                      ...
                      <div className="bh-print-modal__page"
                        ...
                        <div className="bh-print-modal__cover">
                          ...
                          <p style={{ fontFamily: "sans-serif", fontSize: layout.fontSize * 1.1, color: "#666" }}>
                            by {bookIdDetails?.author || "Author"}
                          </p>
                        </div>
                      </div>
                      <div className="bh-print-modal__page-num"
                        style={{ position: "absolute", top: scaledH + 6, left: 0, width: "100%" }}>
                        Cover
                      </div>
                    </div>
                  );
                  ...
                  <div key={idx} className="bh-print-modal__page-wrap"
                    ...
                    <div className="bh-print-modal__page"
                      ...
                      <div style={{ display: "flex", alignItems: "center", gap: 8,
                        ...
                        <span style={{ fontFamily: "monospace", fontSize: 7, color: "#ccc" }}>
    ...
    <>
      <header className="book-header">
        ...
        <div className="book-identity">
          <div className="book-identity__icon">
            <BookOpen size={17} />
          </div>
          <div className="book-identity__text">
            <h3 className="book-identity__title">{title || "Untitled Book"}</h3>
            {chapterCount > 0 && (
              <span className="book-identity__meta">{chapterCount} chapter{chapterCount !== 1 ? "s" : ""}</span>
            )}
          </div>
        </div>
...
>
  ...
  Mark as complete
          ...
          {/* Download PDF + size toggle */}
          <div className="bh-pdf-group" ref={sizeRef}>
            <button
              className="bh-btn bh-btn--ghost-red bh-pdf-main"
